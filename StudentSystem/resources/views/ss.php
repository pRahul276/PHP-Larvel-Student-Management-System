<!--/* filename    : ss.php
** Date        : 14/11/2020
** Description : To setup Larvel Enviornment
*/-->
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <form method="post" action="{{URL::to{'/createSchool'}}}" >
            <table border="0" cellpadding="10" style="margin-left:auto; margin-right:auto;background-color:#fafad2;">
            <tr>
                    <td><strong>Create a School</strong></td>      
            <tr>
                    <td><strong>School Name</strong></td>
                    <td><input type="text" value="" name="login" size="20" /></td>
            </tr>
            </table>
